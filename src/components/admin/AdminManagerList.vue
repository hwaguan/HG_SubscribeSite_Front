<template>
    <div class="mainContainer">
        <div class="mainHeader">
            <div class="mainTitle">
                <h3>管理員設定 - <span class="titleMid">管理員列表</span></h3>
            </div>
        ...
        <div class="zeroRow" v-if="managerCount == 0">
            <div>
                <h4>未尋獲任何資料...</h4>
            </div>
        ...
        <div class="listContainer" v-if="managerCount > 0">
            <div class="resultRows">
                <div class="showRemoved">
                    <div class="reviveBtn btn btn-sm" :class="{ 'enableRevive': !showAll, 'btn-primary': showAll }"
                        @click="showRemovedData">顯示已刪除資料</div>
                </div>
                <div class="resultCount">資料總筆數：<span class="resultNumber">{{ managerCount }}</span> 筆</div>
            </div>
            <div class="listTitle">
            ...
            <div class="listBody">
                <div class="listLineContainer" v-for="(manager, index) in managerList" :key="index"
...
const managerTotalPath = config.hostPath + config.adminManagerTotalPath
const managerListPath = config.hostPath + config.adminManagerListPath
