<template>
  ...
  <div class="serviceContainer">
    <div class="functionTab">
      <div class="tabItem" :class="{ memberTab: pickedTab == 1 }" @click="switchTab(1)">
        會員服務
      </div>
      <div
        class="tabItem"
        :class="{ productTab: pickedTab == 2 }"
        @click="switchTab(2)"
        v-if="false"
      >
        產品說明
      </div>
      <div class="tabItem" :class="{ paymentTab: pickedTab == 2 }" @click="switchTab(2)">
        付款問題
      </div>
    </div>
    <div
      ...
      :class="{
        memberBody: pickedTab == 1,
        productBody: pickedTab == 9,
        paymentBody: pickedTab == 2
      }"
    >
...
.memberBody {
  border: 2px rgba(255, 0, 0, 0.5) solid !important;
}
...
.paymentBody {
  border: 2px rgba(255, 144, 0, 0.5) solid !important;
}
