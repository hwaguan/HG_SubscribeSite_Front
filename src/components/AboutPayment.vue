<template>
    <div class="webSelection">
        <div :class="{ 'selectionItem': pickedItem != (index + 1), 'selectionItem_picked': pickedItem == (index + 1) }"
            v-for="(sel, index) in slideList" :key="index" @click="switchCase(index + 1)">{{ sel.text }}</div>
    </div>
    <Carousel :items-to-show="2.5" :wrap-around="true" ref="carousel" class="mobileSelection" v-model="currentSlide">
        ...
        <template #addons>
            <navigation>
                <template #next>
                    <svg class="carousel__icon" viewBox="0 0 20 20"
                        style="width : 24px; height : 24px; position : absolute; right : -30px;" role="img"
                        aria-label="Arrow pointing to the right" @click="switchCase(pickedItem + 1)">
                        <title>下一則</title>
                ...
                <template #prev>
                    <svg class="carousel__icon" viewBox="0 0 20 20"
                        style="width : 24px; height : 24px; position : absolute; left : -35px;" role="img"
                        aria-label="Arrow pointing to the left" @click="switchCase(pickedItem - 1)">
                        <title>上一則</title>
    ...
    <div class="storeTabContainer" v-if="pickedItem == 5">
        <div class="storeTabContainerCase">
            <div class="sevenTab" :class="{ 'sevenTab_active': m_type == 1 }" @click="changeMT(1)" title="7-ELEVEN ibon"></div>
        </div>
        <div class="storeTabContainerCase">
            <div class="familyTab" :class="{ 'familyTab_active': m_type == 2 }" @click="changeMT(2)" title="全家 FamiPort"></div>
        </div>
        <div class="storeTabContainerCase">
            <div class="hilifeTab" :class="{ 'hilifeTab_active': m_type == 3 }" @click="changeMT(3)" title="萊爾富 Life-ET"></div>
        </div>
    </div>
    <div class="paymentContainer">
        ...
        <div class="paymentRefund">
            ...
            <div class="fdrundBlock">
                ...
                <div class="refundContent longText">會員如申請退費之程序須配合本公司作業流程，撥款日以本公司會計作帳時間為準。</div>
            </div>
        </div>
        ...
        <div class="paymentFAQ">
            <div class="bolckContainerBlock">
                ...
                <div class="bolckContainerContent longText question">信用卡付費，持卡人可以選擇哪些卡片？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">提供消費者使用 VISA / MASTER / JCB 等卡片進行刷卡消費。</div>
            </div>
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
            ...
            <div class="bolckContainerBlock">
                ...
                <div class="bolckContainerContent longText">
                    ...
                    <div class="bolckContainerBlock">
                        ...
                        <div class="bolckContainerContent longText">此筆卡號同時有人刷卡授權中，因此視窗會跳出。</div>
            ...
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">使用超商條碼/代碼付款需要負擔手續費嗎？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">消手續費由本公司負擔，提醒您！超商店員不會在結帳時另外收取手續費。</div>
            </div>
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">超商付款繳款期限已過了該怎麼辦？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">繳款代碼/條碼一但超過繳費期限，該筆訂單將自動取消。請重新訂購商品，再次取得一組新的繳費代碼/條碼。</div>
            </div>
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">超商付款後需要將收據回傳嗎？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">不用。提醒您！務必將繳費證明單妥善收放，以應日後發生帳務問題時核對！</div>
            </div>
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">ATM櫃員機轉帳失敗？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">可能的原因有：
                    <div class="transferFailed">
                        ...
                        <div class="transferFailedRow">
                            <div>匯款金額輸入錯誤</div>
                            <div>請於重新轉帳時，檢查匯款金額是否輸入正確。(金額與您當初購買之賣場金額需一致)</div>
                        </div>
                        <div class="transferFailedRow">
                            <div>帳號繳款期限過期</div>
            ...
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">網路ATM、ATM櫃員機轉帳、超商代碼、及網路超商代碼繳費，最晚的繳費期限為何？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">
                    <div class="bolckContainerBlock">
                        <div class="bolckContainerNo ">1.</div>
                        <div class="bolckContainerContent longText">網路ATM、ATM櫃員機轉帳，繳費期限為４天。</div>
                        <div class="bolckContainerNo ">2.</div>
                        <div class="bolckContainerContent longText">超商代碼、及網路超商代碼繳費，繳費期限為7天。</div>
                    </div>
            ...
            <div class="bolckContainerBlock">
                ...
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">付款成功後，將會發送email及簡訊通知。也可至「會員專區-購買紀錄」查詢。如有其他問題，請與我們聯繫查詢。</div>
            </div>
            <div class="bolckContainerBlock">
                <div class="bolckContainerNo question">Q </div>
                <div class="bolckContainerContent longText question">付款成功後，是否可以馬上使用購買之產品功能？</div>
                <div class="bolckContainerNo ">A </div>
                <div class="bolckContainerContent longText">線上付款成功後，利用您所註冊之會員帳號登入「會員專區」，可馬上使用網站之購買產品功能。</div>
            </div>
        </div>
    </div>
</template>
...
.webSelection {
    ...
    .selectionItem:hover {
        background-color: rgba(255, 144, 0, .2);
    }
...
.paymentContainer {
    ...
    .paymentFAQHead {
        ...
        margin-top: 50px;
        border-left: 10px rgba(255, 144, 0, .5) solid;
...
.storeTabContainer {
    ...
    .storeTabContainerCase {
        ...
        .hilifeTab {
            ...
            height: 40px;
            border-radius: 99rem;
            box-shadow: 2px 2px 5px rgba(150, 150, 150, .2);
